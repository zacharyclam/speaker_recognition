...
def split_data(data_dir, usage, enroll_sentence_nums=20, val_sentence_nums=1):
    """
    ...
    for i, file_list in enumerate(data_list):
        enroll_data.append((file_list[:enroll_sentence_nums], i))
        val_data.append((file_list[enroll_sentence_nums:enroll_sentence_nums + val_sentence_nums], i))

    return enroll_data, val_data
...
if __name__ == "__main__":
    ...
    # enroll_distance = []
    # # print("mean dist:", end=" ")
    # val_distance = [getCDS(val_features, enroll_feature) for enrol_label, enroll_feature in enroll_people.items()]
    # predict_label = np.argmax(val_distance, axis=0)
    # print(predict_label)
    # distance = np.array([getCDS(val_feature, enroll_feature) for val_feature in val_features]).mean(axis=0)
    #         enroll_distance.append(distance)
    #     predict_label = np.argmax(enroll_distance, axis=0)
    #     # print(predict_label, end="  ")
    #     # print(enroll_distance)
    #     print(enroll_distance[predict_label], end=" ")
    #     if predict_label == int(val_label):
    #         cnt += 1
    #     # print(" ")
    # print(cnt)
